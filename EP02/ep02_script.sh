...
# 2. Executa o programa com LIKWID para medir operações FP em dupla precisão
# obtidos estes valores do processo de fatoração LU e do cálculo de cada solução das EDO's
